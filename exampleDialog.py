...
class Window(QtWidgets.QDialog):
    ...
    def createComboBox(self, text=""):
        ...
        comboBox.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding,
    ...
    def createFilesTable(self):
        ...
        self.filesTable.horizontalHeader().setSectionResizeMode(0, QtWidgets.QHeaderView.ResizeMode.Stretch)
